...
def select_nvfp4_moe_backend(
    ...
    # EMULATION is last so auto still prefers native/Marlin; formal runs
    # must set moe_backend="emulation" explicitly.
    AVAILABLE_BACKENDS = [
        NvFp4MoeBackend.FLASHINFER_TRTLLM,
        NvFp4MoeBackend.FLASHINFER_CUTEDSL,
        NvFp4MoeBackend.FLASHINFER_CUTLASS,
...
def make_nvfp4_moe_quant_config(
    ...
    if backend == NvFp4MoeBackend.MARLIN:
        ...
        # convert_to_nvfp4_moe_kernel_format already applied
        # a13_scale = 1.0 / a13_scale.max() (and same for a2).
