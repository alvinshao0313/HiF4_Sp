...
STAGE_ORDER = (
    ...
    "S4_HOLDOUT_ACTUAL_VALIDATE",
    "S4_PATH_MECHANISM_AUDIT",
    "S4_CORRECTED_PATH_ALIGNMENT",
    "S4_ARITHMETIC_ALIGNMENT",
    "S4_KERNEL_BOUNDARY_ALIGNMENT",
    "S4_MECHANISM_PREPARE",
    "S4_MECHANISM_VALIDATE",
