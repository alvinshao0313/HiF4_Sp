...
> 本文命令保留归档前的路径与配置语境，不作为当前直接运行入口。源码位置和仍在使用的共享依赖见 [归档说明](../../README.md)。
...
- 工具：[`common.py`](common.py)；R64 仍保留在共享源码位置：[`r64_transform.py`](../../../../Native_NVFP4_HiF4_Linear_Puncture/experiments/diag_gradient/r64_transform.py)
- 改超参：`LR` / `STEPS` 环境变量
