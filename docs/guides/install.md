...
> HiF4_Sp 使用指南。命令默认从仓库根目录执行；涉及环境安装或变更时遵守 [AGENTS.md](../../AGENTS.md)。返回 [文档入口](../README.md)。
...
- [vllm_install_notes.md](../experience/history/environment/vllm_install_notes.md)
- [vllm_0_17_source_build_guide.md](../experience/history/environment/vllm_0_17_source_build_guide.md)（历史迁移记录，不要按它切回旧版本）
...
详见 [vllm_install_notes.md](../experience/history/environment/vllm_install_notes.md)。
...
| [vllm_install_notes.md](../experience/history/environment/vllm_install_notes.md) | vLLM 预编译 ABI 问题与方案选择 |
| [vllm_0_17_source_build_guide.md](../experience/history/environment/vllm_0_17_source_build_guide.md) | 历史源码编译报错与变量说明 |
